...
const NearestStationModal: React.FC<Props> = ({ isOpen, onClose }) => {
  const [stationType, setStationType] = useState('Train station');
  ...
  const selectStationType = (type: string) => {
    setStationType(type);
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                ...
                >
                  <span className="text-gray-900">{stationType}</span>
                ...
                {showStationDropdown && (
                  <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                    {stationTypes.map((type) => (
                      <button
                        key={type}
                        onClick={() => selectStationType(type)}
...
const NearestStationDemo: React.FC = () => {
...
export default NearestStationDemo;
export { NearestStationModal};